...
<nav class="navbar navbar-expand-lg navbar-dark sticky-top">
   <div class="container">
     <a class="navbar-brand d-flex align-items-center" href="../front-pages/index.php">
     ...
     <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
       <ul class="navbar-nav">
         ...
         <li class="nav-item">
           <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == 'contact.php') echo 'active'; ?>" href="../front-pages/contact.php">Contact Us</a>
         </li>
         <li class="nav-item">
           <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == 'resources.php') echo 'active'; ?>" href="../front-pages/guides.php">Guides</a>
         </li>
         <?php if (isset($_SESSION['user_id'])): ?>
         <li class="nav-item">
           <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == 'my_account.php') echo 'active'; ?>" href="../front-pages/my_account.php">My Account</a>
         </li>
         <?php else: ?>
           <li class="nav-item">
             <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == '../front-pages/my_account.php') echo 'active'; ?>" href="#" data-bs-toggle="offcanvas" data-bs-target="#loginDrawer" aria-controls="loginDrawer">My Account</a>
           </li>
         <?php endif; ?>
       </ul>
     </div>
